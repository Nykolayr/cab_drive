...
import '../../customer/create_map_page/main_user_widget.dart';
import '../../login/login/presentation/auth_page.dart';
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: GeoWidget.routeName,
          path: GeoWidget.routePath,
          builder: (context, params) => GeoWidget(
        ...
        FFRoute(
          ...
          path: VerifDriverWidget.routePath,
          builder: (context, params) => VerifDriverWidget(
            home: params.getParam(
              'home',
              ParamType.int,
            ),
        ...
        FFRoute(
          ...
          path: DetaliySozdanieWidget.routePath,
          builder: (context, params) => DetaliySozdanieWidget(
            car: params.getParam<Car>(
              'car',
              ParamType.Enum,
            ),
          ),
        ...
        FFRoute(
          name: OrderPageCustomerWidget.routeName,
          path: OrderPageCustomerWidget.routePath,
          builder: (context, params) => OrderPageCustomerWidget(
        ...
        FFRoute(
          name: ZakazNaKarteWidget.routeName,
          path: ZakazNaKarteWidget.routePath,
          builder: (context, params) => ZakazNaKarteWidget(
            order: params.getParam(
              'order',
              ParamType.DocumentReference,
              isList: false,
        ...
        FFRoute(
          ...
          path: OrderPageDriverWidget.routePath,
          builder: (context, params) => OrderPageDriverWidget(
            order: params.getParam(
              'order',
              ParamType.DocumentReference,
              isList: false,
        ...
        FFRoute(
          ...
          path: DetaliZayavkiAdminWidget.routePath,
          builder: (context, params) => DetaliZayavkiAdminWidget(
            docref: params.getParam(
              'docref',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['request_verefication'],
            ),
          ),
        ),
        FFRoute(
          name: OtpLoginWidget.routeName,
          path: OtpLoginWidget.routePath,
