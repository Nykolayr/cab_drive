...
class OrderRecord extends FirestoreRecord {
  ...
  // "pointC" field.
  PointStruct? _pointC;
  PointStruct get pointC => _pointC ?? PointStruct();
  bool hasPointC() => _pointC != null;
  ...
  String get distanceStr => ((_distance ?? 0) / 1000).toStringAsFixed(1) + ' км';
  ...
  int? _commissionPercent;
  int? get commissionPercent => _commissionPercent;
  ...
  // "image_compl" field.
  List<String>? _imageCompl;
  List<String> get imageCompl => _imageCompl ?? [];
  ...
  void _initializeFields() {
    ...
    _pointC = snapshotData['pointC'] is PointStruct
        ? snapshotData['pointC']
        : PointStruct.maybeFromMap(snapshotData['pointC']);
    ...
    _commissionPercent = snapshotData['commissionPercent'] as int?;
    ...
    _imageCompl = ((snapshotData['image_compl'] as List? ) ?? []).map((e) => e.toString()).toList();
...
Map<String, dynamic> createOrderRecordData({
  ...
  // Handle nested data for "pointC" field.
  addPointStructData(firestoreData, pointC, 'pointC');
