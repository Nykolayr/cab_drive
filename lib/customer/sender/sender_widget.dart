...
class _SenderWidgetState extends State<SenderWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SenderModel());
    ...
    _model.nameTextController ??=
        TextEditingController(text: FFAppState().pointA.sender.name);
    _model.nameFocusNode ??= FocusNode();

    _model.phoneTextController ??=
        TextEditingController(text: FFAppState().pointA.sender.phone);
    _model.phoneFocusNode ??= FocusNode();

    _model.phoneMask = MaskTextInputFormatter(mask: '###########');
    _model.switchValue = FFAppState().pointA.sender.itsMe;
  }
