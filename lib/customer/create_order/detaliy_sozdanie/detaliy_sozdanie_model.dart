...
class DetaliySozdanieModel extends FlutterFlowModel<DetaliySozdanieWidget> {
  ...
  // State field(s) for entrance_C widget.
  FocusNode? entranceCFocusNode;
  TextEditingController? entranceCTextController;
  String? Function(BuildContext, String?)? entranceCTextControllerValidator;
...
// State field(s) for flat_C widget.
  FocusNode? flatCFocusNode;
  TextEditingController? flatCTextController;
  String? Function(BuildContext, String?)? flatCTextControllerValidator;
  // State field(s) for Floor_C widget.
  FocusNode? floorCFocusNode;
  TextEditingController? floorCTextController;
  String? Function(BuildContext, String?)? floorCTextControllerValidator;
  // State field(s) for Intercom_C widget.
  FocusNode? intercomCFocusNode;
  TextEditingController? intercomCTextController;
  String? Function(BuildContext, String?)? intercomCTextControllerValidator;
  // State field(s) for comment_C widget.
  FocusNode? commentCFocusNode;
  TextEditingController? commentCTextController;
  String? Function(BuildContext, String?)? commentCTextControllerValidator;
  DateTime? datePicked;
  ...
  void dispose() {
    ...
    entranceCFocusNode?.dispose();
    entranceCTextController?.dispose();

    flatCFocusNode?.dispose();
    flatCTextController?.dispose();

    floorCFocusNode?.dispose();
    floorCTextController?.dispose();

    intercomCFocusNode?.dispose();
    intercomCTextController?.dispose();

    commentCFocusNode?.dispose();
    commentCTextController?.dispose();
